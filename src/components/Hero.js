...
const Hero = () =>{
    ...
    <section id="home" className="min-h-screen flex items-center hero-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          className="bg-primary-accent text-offwhite px-6 py-3 rounded-lg hover:bg-primary-dark transition-colors shadow-text"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
            View My Work
            </ motion.a>
            <motion.a href="/resume/viraj_resume.pdf" download="Viraj_shedge_resume" 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
